...
def eval(model, eval_loader, optimizer, epoch, loss_func_name='cross_entropy', desc='Validation', verbose=True,
    ...
    if auc > best_auc:
        best_auc = auc
        state = {'model': model.state_dict(), 'optimizer': optimizer.state_dict(), 'epoch': epoch, "best_auc": best_auc,
                 "best_spauc": spauc}
...
if __name__ == '__main__':
    ...
    parser.add_argument('--tgt_root', default='E:\Transfer_Learning\Data\HK_sample\csv')
