...
def generate_tgt_representation(model, data_loader, target_month_name):
    ...
    with open(target_month_name,"rb") as fp:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--mark', default="subspace", type=str)
    ...
    model_name = args.datasets + "_" + testpath.split("/")[-1].split("_")[-1].replace(".csv","") + "_" + args.mark + "_subspace" + args.para + ".pt" 
    ...
    target_month_name = args.datasets + "_" + testpath.split("/")[-1].split("_")[-1].replace(".csv","") + "_month_{}.pkl".format(args.mark.replace("prct",""))
